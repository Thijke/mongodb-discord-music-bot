            ...
            options: [
                {
                    type: "1",
                    name: "add",
                    description: "Add the current playing song to your favorites | by thijke#1234",
                },
                {
                    type: "1",
                    name: "remove",
                    description: "Remove a song from your favorites | by thijke#1234",
                    options: [
                        {
                            type: "3",
                            name: "song",
                ...
                },
                {
                    type: "1",
                    name: "list",
                    description: "List your favorite songs | by thijke#1234",
                },
                {
                    type: "1",
                    name: "play",
                    description: "Play one of your favorite songs | by thijke#1234",
                    options: [
                        {
                            type: "4",
                            name: "song",
