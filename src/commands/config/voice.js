            ...
            options: [
                {
                    type: "1",
                    name: "add",
                    description: "Add a voice channel to the allowed list | by thijke#1234",
                    options: [
                        {
                            type: "7",
                            name: "channel",
                ...
                },
                {
                    type: "1",
                    name: "remove",
                    description: "Remove a voice channel from the allowed list | by thijke#1234",
                    options: [
                        {
                            type: "7",
                            name: "channel",
                ...
                },
                {
                    type: "1",
                    name: "list",
                    description: "List the allowed voice channels | by thijke#1234",
                },
            ],
        });
    }
