            ...
            options: [
                {
                    type: "1",
                    name: "add",
                    description: "Add a role to the DJ roles list | by thijke#1234",
                    options: [
                        {
                            type: "8",
                            name: "role",
                ...
                },
                {
                    type: "1",
                    name: "remove",
                    description: "Remove a role from the DJ roles list | by thijke#1234",
                    options: [
                        {
                            type: "8",
                            name: "role",
                ...
                },
                {
                    type: "1",
                    name: "list",
                    description: "List all DJ roles | by thijke#1234",
                },
            ],
        });
    }
